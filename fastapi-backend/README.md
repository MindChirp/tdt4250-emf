...
│ ├── routers/
│ │ ├── game_state.py # GET /game-state
│ │ └── moves.py # POST /move
│ ├── services/
│ │ ├── game_manager.py # Stores active players + tile states
│ │ └── legal_moves.py # (future) pipeline support
│ ├── models/
│ │ ├── game_state_response.py
│ │ └── move_request.py
│ ├── generated/
│ │ ├── engine/models.py # Generated from DSL
│ │ └── games/*.py # One game file per .bgdsl model
│ └── init.py
│
├── requirements.txt
└── README.md
