...
public class InternalBgDslParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_STRING", "RULE_ID", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'Game'", "'{'", "'turnPolicy'", "'initialPlayer'", "'board'", "'players'", "','", "'}'", "'checkered'", "'Board'", "'width'", "'height'", "'tiles'", "'legalMovesPipeline'", "'effectPipeline'", "'tileplacement'", "'Player'", "'hexColor'", "'associatedState'", "'-'", "'Tile'", "'name'", "'states'", "'transitions'", "'initialState'", "'LegalMovesPipeline'", "'filters'", "'EffectPipeline'", "'TilePlacement'", "'row'", "'column'", "'tile'", "'State'", "'outbound'", "'('", "')'", "'inbound'", "'Transition'", "'source'", "'target'", "'PatternFilter'", "'nextFilter'", "'patterns'", "'IterativeFilter'", "'directionVectors'", "'matchRule'", "'endRule'", "'StateEffectFilter'", "'stateSelection'", "'targetState'", "'WinConditionFilter'", "'Pattern'", "'matchState'", "'relativecoordinates'", "'RelativeCoordinate'", "'x'", "'y'", "'TurnBased'", "'Simultaneous'", "'CurrentPlayer'", "'OtherPlayer'", "'StateBased'"
    };
    ...
    // InternalBgDsl.g:244:1: ruleFilter returns [EObject current=null] : (this_PatternFilter_0= rulePatternFilter | this_IterativeFilter_1= ruleIterativeFilter | this_StateEffectFilter_2= ruleStateEffectFilter | this_WinConditionFilter_3= ruleWinConditionFilter ) ;
    public final EObject ruleFilter() throws RecognitionException {
        ...
        EObject this_WinConditionFilter_3 = null;
        ...
        try {
            // InternalBgDsl.g:250:2: ( (this_PatternFilter_0= rulePatternFilter | this_IterativeFilter_1= ruleIterativeFilter | this_StateEffectFilter_2= ruleStateEffectFilter | this_WinConditionFilter_3= ruleWinConditionFilter ) )
            // InternalBgDsl.g:251:2: (this_PatternFilter_0= rulePatternFilter | this_IterativeFilter_1= ruleIterativeFilter | this_StateEffectFilter_2= ruleStateEffectFilter | this_WinConditionFilter_3= ruleWinConditionFilter )
            {
            // InternalBgDsl.g:251:2: (this_PatternFilter_0= rulePatternFilter | this_IterativeFilter_1= ruleIterativeFilter | this_StateEffectFilter_2= ruleStateEffectFilter | this_WinConditionFilter_3= ruleWinConditionFilter )
            int alt2=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt2) {
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // InternalBgDsl.g:279:3: this_WinConditionFilter_3= ruleWinConditionFilter
                    {
                    ...
                    state._fsp--;
                    			...
                    			current = this_WinConditionFilter_3;
                    			afterParserOrEnumRuleCall();
    ...
    // InternalBgDsl.g:291:1: entryRuleBoard returns [EObject current=null] : iv_ruleBoard= ruleBoard EOF ;
    public final EObject entryRuleBoard() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:291:46: (iv_ruleBoard= ruleBoard EOF )
            // InternalBgDsl.g:292:2: iv_ruleBoard= ruleBoard EOF
            {
    ...
    public final EObject ruleBoard() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:304:2: ( ( ( (lv_checkered_0_0= 'checkered' ) ) otherlv_1= 'Board' otherlv_2= '{' otherlv_3= 'width' ( (lv_width_4_0= ruleEInt ) ) otherlv_5= 'height' ( (lv_height_6_0= ruleEInt ) ) otherlv_7= 'tiles' otherlv_8= '{' ( (lv_tiles_9_0= ruleTile ) ) (otherlv_10= ',' ( (lv_tiles_11_0= ruleTile ) ) )* otherlv_12= '}' (otherlv_13= 'legalMovesPipeline' ( (lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline ) ) )? (otherlv_15= 'effectPipeline' ( (lv_effectPipeline_16_0= ruleEffectPipeline ) ) )? otherlv_17= 'tileplacement' otherlv_18= '{' ( (lv_tileplacement_19_0= ruleTilePlacement ) ) (otherlv_20= ',' ( (lv_tileplacement_21_0= ruleTilePlacement ) ) )* otherlv_22= '}' otherlv_23= '}' ) )
            // InternalBgDsl.g:305:2: ( ( (lv_checkered_0_0= 'checkered' ) ) otherlv_1= 'Board' otherlv_2= '{' otherlv_3= 'width' ( (lv_width_4_0= ruleEInt ) ) otherlv_5= 'height' ( (lv_height_6_0= ruleEInt ) ) otherlv_7= 'tiles' otherlv_8= '{' ( (lv_tiles_9_0= ruleTile ) ) (otherlv_10= ',' ( (lv_tiles_11_0= ruleTile ) ) )* otherlv_12= '}' (otherlv_13= 'legalMovesPipeline' ( (lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline ) ) )? (otherlv_15= 'effectPipeline' ( (lv_effectPipeline_16_0= ruleEffectPipeline ) ) )? otherlv_17= 'tileplacement' otherlv_18= '{' ( (lv_tileplacement_19_0= ruleTilePlacement ) ) (otherlv_20= ',' ( (lv_tileplacement_21_0= ruleTilePlacement ) ) )* otherlv_22= '}' otherlv_23= '}' )
            {
            // InternalBgDsl.g:305:2: ( ( (lv_checkered_0_0= 'checkered' ) ) otherlv_1= 'Board' otherlv_2= '{' otherlv_3= 'width' ( (lv_width_4_0= ruleEInt ) ) otherlv_5= 'height' ( (lv_height_6_0= ruleEInt ) ) otherlv_7= 'tiles' otherlv_8= '{' ( (lv_tiles_9_0= ruleTile ) ) (otherlv_10= ',' ( (lv_tiles_11_0= ruleTile ) ) )* otherlv_12= '}' (otherlv_13= 'legalMovesPipeline' ( (lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline ) ) )? (otherlv_15= 'effectPipeline' ( (lv_effectPipeline_16_0= ruleEffectPipeline ) ) )? otherlv_17= 'tileplacement' otherlv_18= '{' ( (lv_tileplacement_19_0= ruleTilePlacement ) ) (otherlv_20= ',' ( (lv_tileplacement_21_0= ruleTilePlacement ) ) )* otherlv_22= '}' otherlv_23= '}' )
            // InternalBgDsl.g:306:3: ( (lv_checkered_0_0= 'checkered' ) ) otherlv_1= 'Board' otherlv_2= '{' otherlv_3= 'width' ( (lv_width_4_0= ruleEInt ) ) otherlv_5= 'height' ( (lv_height_6_0= ruleEInt ) ) otherlv_7= 'tiles' otherlv_8= '{' ( (lv_tiles_9_0= ruleTile ) ) (otherlv_10= ',' ( (lv_tiles_11_0= ruleTile ) ) )* otherlv_12= '}' (otherlv_13= 'legalMovesPipeline' ( (lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline ) ) )? (otherlv_15= 'effectPipeline' ( (lv_effectPipeline_16_0= ruleEffectPipeline ) ) )? otherlv_17= 'tileplacement' otherlv_18= '{' ( (lv_tileplacement_19_0= ruleTilePlacement ) ) (otherlv_20= ',' ( (lv_tileplacement_21_0= ruleTilePlacement ) ) )* otherlv_22= '}' otherlv_23= '}'
            {
            // InternalBgDsl.g:306:3: ( (lv_checkered_0_0= 'checkered' ) )
            // InternalBgDsl.g:307:4: (lv_checkered_0_0= 'checkered' )
            {
            // InternalBgDsl.g:307:4: (lv_checkered_0_0= 'checkered' )
            // InternalBgDsl.g:308:5: lv_checkered_0_0= 'checkered'
            {
            ...
            // InternalBgDsl.g:332:3: ( (lv_width_4_0= ruleEInt ) )
            // InternalBgDsl.g:333:4: (lv_width_4_0= ruleEInt )
            {
            // InternalBgDsl.g:333:4: (lv_width_4_0= ruleEInt )
            // InternalBgDsl.g:334:5: lv_width_4_0= ruleEInt
            {
            ...
            // InternalBgDsl.g:355:3: ( (lv_height_6_0= ruleEInt ) )
            // InternalBgDsl.g:356:4: (lv_height_6_0= ruleEInt )
            {
            // InternalBgDsl.g:356:4: (lv_height_6_0= ruleEInt )
            // InternalBgDsl.g:357:5: lv_height_6_0= ruleEInt
            {
            ...
            // InternalBgDsl.g:382:3: ( (lv_tiles_9_0= ruleTile ) )
            // InternalBgDsl.g:383:4: (lv_tiles_9_0= ruleTile )
            {
            // InternalBgDsl.g:383:4: (lv_tiles_9_0= ruleTile )
            // InternalBgDsl.g:384:5: lv_tiles_9_0= ruleTile
            {
            ...
            // InternalBgDsl.g:401:3: (otherlv_10= ',' ( (lv_tiles_11_0= ruleTile ) ) )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalBgDsl.g:402:4: otherlv_10= ',' ( (lv_tiles_11_0= ruleTile ) )
            	    {
            	    otherlv_10=(Token)match(input,17,FOLLOW_19); 

            	    				newLeafNode(otherlv_10, grammarAccess.getBoardAccess().getCommaKeyword_10_0());
            	    			
            	    // InternalBgDsl.g:406:4: ( (lv_tiles_11_0= ruleTile ) )
            	    // InternalBgDsl.g:407:5: (lv_tiles_11_0= ruleTile )
            	    {
            	    // InternalBgDsl.g:407:5: (lv_tiles_11_0= ruleTile )
            	    // InternalBgDsl.g:408:6: lv_tiles_11_0= ruleTile
            	    {
            ...
            // InternalBgDsl.g:430:3: (otherlv_13= 'legalMovesPipeline' ( (lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline ) ) )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalBgDsl.g:431:4: otherlv_13= 'legalMovesPipeline' ( (lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline ) )
                    {
                    ...
                    // InternalBgDsl.g:435:4: ( (lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline ) )
                    // InternalBgDsl.g:436:5: (lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline )
                    {
                    // InternalBgDsl.g:436:5: (lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline )
                    // InternalBgDsl.g:437:6: lv_legalMovesPipeline_14_0= ruleLegalMovesPipeline
                    {
            ...
            // InternalBgDsl.g:455:3: (otherlv_15= 'effectPipeline' ( (lv_effectPipeline_16_0= ruleEffectPipeline ) ) )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalBgDsl.g:456:4: otherlv_15= 'effectPipeline' ( (lv_effectPipeline_16_0= ruleEffectPipeline ) )
                    {
                    ...
                    // InternalBgDsl.g:460:4: ( (lv_effectPipeline_16_0= ruleEffectPipeline ) )
                    // InternalBgDsl.g:461:5: (lv_effectPipeline_16_0= ruleEffectPipeline )
                    {
                    // InternalBgDsl.g:461:5: (lv_effectPipeline_16_0= ruleEffectPipeline )
                    // InternalBgDsl.g:462:6: lv_effectPipeline_16_0= ruleEffectPipeline
                    {
            ...
            // InternalBgDsl.g:488:3: ( (lv_tileplacement_19_0= ruleTilePlacement ) )
            // InternalBgDsl.g:489:4: (lv_tileplacement_19_0= ruleTilePlacement )
            {
            // InternalBgDsl.g:489:4: (lv_tileplacement_19_0= ruleTilePlacement )
            // InternalBgDsl.g:490:5: lv_tileplacement_19_0= ruleTilePlacement
            {
            ...
            // InternalBgDsl.g:507:3: (otherlv_20= ',' ( (lv_tileplacement_21_0= ruleTilePlacement ) ) )*
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalBgDsl.g:508:4: otherlv_20= ',' ( (lv_tileplacement_21_0= ruleTilePlacement ) )
            	    {
            	    otherlv_20=(Token)match(input,17,FOLLOW_25); 

            	    				newLeafNode(otherlv_20, grammarAccess.getBoardAccess().getCommaKeyword_17_0());
            	    			
            	    // InternalBgDsl.g:512:4: ( (lv_tileplacement_21_0= ruleTilePlacement ) )
            	    // InternalBgDsl.g:513:5: (lv_tileplacement_21_0= ruleTilePlacement )
            	    {
            	    // InternalBgDsl.g:513:5: (lv_tileplacement_21_0= ruleTilePlacement )
            	    // InternalBgDsl.g:514:6: lv_tileplacement_21_0= ruleTilePlacement
            	    {
    ...
    // InternalBgDsl.g:544:1: entryRuleEString returns [String current=null] : iv_ruleEString= ruleEString EOF ;
    public final String entryRuleEString() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:544:47: (iv_ruleEString= ruleEString EOF )
            // InternalBgDsl.g:545:2: iv_ruleEString= ruleEString EOF
            {
    ...
    // InternalBgDsl.g:551:1: ruleEString returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_STRING_0= RULE_STRING | this_ID_1= RULE_ID ) ;
    public final AntlrDatatypeRuleToken ruleEString() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:557:2: ( (this_STRING_0= RULE_STRING | this_ID_1= RULE_ID ) )
            // InternalBgDsl.g:558:2: (this_STRING_0= RULE_STRING | this_ID_1= RULE_ID )
            {
            // InternalBgDsl.g:558:2: (this_STRING_0= RULE_STRING | this_ID_1= RULE_ID )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalBgDsl.g:559:3: this_STRING_0= RULE_STRING
                    {
                    ...
                    break;
                case 2 :
                    // InternalBgDsl.g:567:3: this_ID_1= RULE_ID
                    {
    ...
    // InternalBgDsl.g:578:1: entryRulePlayer returns [EObject current=null] : iv_rulePlayer= rulePlayer EOF ;
    public final EObject entryRulePlayer() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:578:47: (iv_rulePlayer= rulePlayer EOF )
            // InternalBgDsl.g:579:2: iv_rulePlayer= rulePlayer EOF
            {
    ...
    // InternalBgDsl.g:585:1: rulePlayer returns [EObject current=null] : (otherlv_0= 'Player' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) otherlv_5= 'associatedState' ( ( ruleEString ) ) otherlv_7= '}' ) ;
    public final EObject rulePlayer() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:591:2: ( (otherlv_0= 'Player' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) otherlv_5= 'associatedState' ( ( ruleEString ) ) otherlv_7= '}' ) )
            // InternalBgDsl.g:592:2: (otherlv_0= 'Player' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) otherlv_5= 'associatedState' ( ( ruleEString ) ) otherlv_7= '}' )
            {
            // InternalBgDsl.g:592:2: (otherlv_0= 'Player' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) otherlv_5= 'associatedState' ( ( ruleEString ) ) otherlv_7= '}' )
            // InternalBgDsl.g:593:3: otherlv_0= 'Player' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) otherlv_5= 'associatedState' ( ( ruleEString ) ) otherlv_7= '}'
            {
            otherlv_0=(Token)match(input,27,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getPlayerAccess().getPlayerKeyword_0());
            		
            // InternalBgDsl.g:597:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBgDsl.g:598:4: (lv_name_1_0= ruleEString )
            {
            // InternalBgDsl.g:598:4: (lv_name_1_0= ruleEString )
            // InternalBgDsl.g:599:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalBgDsl.g:624:3: ( (lv_hexColor_4_0= ruleEString ) )
            // InternalBgDsl.g:625:4: (lv_hexColor_4_0= ruleEString )
            {
            // InternalBgDsl.g:625:4: (lv_hexColor_4_0= ruleEString )
            // InternalBgDsl.g:626:5: lv_hexColor_4_0= ruleEString
            {
            ...
            // InternalBgDsl.g:647:3: ( ( ruleEString ) )
            // InternalBgDsl.g:648:4: ( ruleEString )
            {
            // InternalBgDsl.g:648:4: ( ruleEString )
            // InternalBgDsl.g:649:5: ruleEString
            {
    ...
    // InternalBgDsl.g:671:1: entryRuleEInt returns [String current=null] : iv_ruleEInt= ruleEInt EOF ;
    public final String entryRuleEInt() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:671:44: (iv_ruleEInt= ruleEInt EOF )
            // InternalBgDsl.g:672:2: iv_ruleEInt= ruleEInt EOF
            {
    ...
    // InternalBgDsl.g:678:1: ruleEInt returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : ( (kw= '-' )? this_INT_1= RULE_INT ) ;
    public final AntlrDatatypeRuleToken ruleEInt() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:684:2: ( ( (kw= '-' )? this_INT_1= RULE_INT ) )
            // InternalBgDsl.g:685:2: ( (kw= '-' )? this_INT_1= RULE_INT )
            {
            // InternalBgDsl.g:685:2: ( (kw= '-' )? this_INT_1= RULE_INT )
            // InternalBgDsl.g:686:3: (kw= '-' )? this_INT_1= RULE_INT
            {
            // InternalBgDsl.g:686:3: (kw= '-' )?
            int alt8=2;
    ...
    // InternalBgDsl.g:704:1: entryRuleTile returns [EObject current=null] : iv_ruleTile= ruleTile EOF ;
    public final EObject entryRuleTile() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:704:45: (iv_ruleTile= ruleTile EOF )
            // InternalBgDsl.g:705:2: iv_ruleTile= ruleTile EOF
            {
    ...
    public final EObject ruleTile() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:717:2: ( (otherlv_0= 'Tile' ( (lv_tileType_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) otherlv_5= 'name' ( (lv_name_6_0= ruleEString ) ) otherlv_7= 'states' otherlv_8= '{' ( (lv_states_9_0= ruleState ) ) (otherlv_10= ',' ( (lv_states_11_0= ruleState ) ) )* otherlv_12= '}' (otherlv_13= 'transitions' otherlv_14= '{' ( (lv_transitions_15_0= ruleTransition ) ) (otherlv_16= ',' ( (lv_transitions_17_0= ruleTransition ) ) )* otherlv_18= '}' )? otherlv_19= 'initialState' ( (lv_initialState_20_0= ruleState ) ) otherlv_21= '}' ) )
            // InternalBgDsl.g:718:2: (otherlv_0= 'Tile' ( (lv_tileType_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) otherlv_5= 'name' ( (lv_name_6_0= ruleEString ) ) otherlv_7= 'states' otherlv_8= '{' ( (lv_states_9_0= ruleState ) ) (otherlv_10= ',' ( (lv_states_11_0= ruleState ) ) )* otherlv_12= '}' (otherlv_13= 'transitions' otherlv_14= '{' ( (lv_transitions_15_0= ruleTransition ) ) (otherlv_16= ',' ( (lv_transitions_17_0= ruleTransition ) ) )* otherlv_18= '}' )? otherlv_19= 'initialState' ( (lv_initialState_20_0= ruleState ) ) otherlv_21= '}' )
            {
            // InternalBgDsl.g:718:2: (otherlv_0= 'Tile' ( (lv_tileType_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) otherlv_5= 'name' ( (lv_name_6_0= ruleEString ) ) otherlv_7= 'states' otherlv_8= '{' ( (lv_states_9_0= ruleState ) ) (otherlv_10= ',' ( (lv_states_11_0= ruleState ) ) )* otherlv_12= '}' (otherlv_13= 'transitions' otherlv_14= '{' ( (lv_transitions_15_0= ruleTransition ) ) (otherlv_16= ',' ( (lv_transitions_17_0= ruleTransition ) ) )* otherlv_18= '}' )? otherlv_19= 'initialState' ( (lv_initialState_20_0= ruleState ) ) otherlv_21= '}' )
            // InternalBgDsl.g:719:3: otherlv_0= 'Tile' ( (lv_tileType_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) otherlv_5= 'name' ( (lv_name_6_0= ruleEString ) ) otherlv_7= 'states' otherlv_8= '{' ( (lv_states_9_0= ruleState ) ) (otherlv_10= ',' ( (lv_states_11_0= ruleState ) ) )* otherlv_12= '}' (otherlv_13= 'transitions' otherlv_14= '{' ( (lv_transitions_15_0= ruleTransition ) ) (otherlv_16= ',' ( (lv_transitions_17_0= ruleTransition ) ) )* otherlv_18= '}' )? otherlv_19= 'initialState' ( (lv_initialState_20_0= ruleState ) ) otherlv_21= '}'
            {
            otherlv_0=(Token)match(input,31,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getTileAccess().getTileKeyword_0());
            		
            // InternalBgDsl.g:723:3: ( (lv_tileType_1_0= ruleEString ) )
            // InternalBgDsl.g:724:4: (lv_tileType_1_0= ruleEString )
            {
            // InternalBgDsl.g:724:4: (lv_tileType_1_0= ruleEString )
            // InternalBgDsl.g:725:5: lv_tileType_1_0= ruleEString
            {
            ...
            // InternalBgDsl.g:750:3: ( (lv_hexColor_4_0= ruleEString ) )
            // InternalBgDsl.g:751:4: (lv_hexColor_4_0= ruleEString )
            {
            // InternalBgDsl.g:751:4: (lv_hexColor_4_0= ruleEString )
            // InternalBgDsl.g:752:5: lv_hexColor_4_0= ruleEString
            {
            ...
            // InternalBgDsl.g:773:3: ( (lv_name_6_0= ruleEString ) )
            // InternalBgDsl.g:774:4: (lv_name_6_0= ruleEString )
            {
            // InternalBgDsl.g:774:4: (lv_name_6_0= ruleEString )
            // InternalBgDsl.g:775:5: lv_name_6_0= ruleEString
            {
            ...
            // InternalBgDsl.g:800:3: ( (lv_states_9_0= ruleState ) )
            // InternalBgDsl.g:801:4: (lv_states_9_0= ruleState )
            {
            // InternalBgDsl.g:801:4: (lv_states_9_0= ruleState )
            // InternalBgDsl.g:802:5: lv_states_9_0= ruleState
            {
            ...
            // InternalBgDsl.g:819:3: (otherlv_10= ',' ( (lv_states_11_0= ruleState ) ) )*
            loop9:
            do {
                int alt9=2;
                ...
                switch (alt9) {
            	case 1 :
            	    // InternalBgDsl.g:820:4: otherlv_10= ',' ( (lv_states_11_0= ruleState ) )
            	    {
            	    otherlv_10=(Token)match(input,17,FOLLOW_31); 

            	    				newLeafNode(otherlv_10, grammarAccess.getTileAccess().getCommaKeyword_10_0());
            	    			
            	    // InternalBgDsl.g:824:4: ( (lv_states_11_0= ruleState ) )
            	    // InternalBgDsl.g:825:5: (lv_states_11_0= ruleState )
            	    {
            	    // InternalBgDsl.g:825:5: (lv_states_11_0= ruleState )
            	    // InternalBgDsl.g:826:6: lv_states_11_0= ruleState
            	    {
            ...
            // InternalBgDsl.g:848:3: (otherlv_13= 'transitions' otherlv_14= '{' ( (lv_transitions_15_0= ruleTransition ) ) (otherlv_16= ',' ( (lv_transitions_17_0= ruleTransition ) ) )* otherlv_18= '}' )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalBgDsl.g:849:4: otherlv_13= 'transitions' otherlv_14= '{' ( (lv_transitions_15_0= ruleTransition ) ) (otherlv_16= ',' ( (lv_transitions_17_0= ruleTransition ) ) )* otherlv_18= '}'
                    {
                    ...
                    // InternalBgDsl.g:857:4: ( (lv_transitions_15_0= ruleTransition ) )
                    // InternalBgDsl.g:858:5: (lv_transitions_15_0= ruleTransition )
                    {
                    // InternalBgDsl.g:858:5: (lv_transitions_15_0= ruleTransition )
                    // InternalBgDsl.g:859:6: lv_transitions_15_0= ruleTransition
                    {
                    ...
                    // InternalBgDsl.g:876:4: (otherlv_16= ',' ( (lv_transitions_17_0= ruleTransition ) ) )*
                    loop10:
                    do {
                        int alt10=2;
                        ...
                        switch (alt10) {
                    	case 1 :
                    	    // InternalBgDsl.g:877:5: otherlv_16= ',' ( (lv_transitions_17_0= ruleTransition ) )
                    	    {
                    	    otherlv_16=(Token)match(input,17,FOLLOW_33); 

                    	    					newLeafNode(otherlv_16, grammarAccess.getTileAccess().getCommaKeyword_12_3_0());
                    	    				
                    	    // InternalBgDsl.g:881:5: ( (lv_transitions_17_0= ruleTransition ) )
                    	    // InternalBgDsl.g:882:6: (lv_transitions_17_0= ruleTransition )
                    	    {
                    	    // InternalBgDsl.g:882:6: (lv_transitions_17_0= ruleTransition )
                    	    // InternalBgDsl.g:883:7: lv_transitions_17_0= ruleTransition
                    	    {
            ...
            // InternalBgDsl.g:910:3: ( (lv_initialState_20_0= ruleState ) )
            // InternalBgDsl.g:911:4: (lv_initialState_20_0= ruleState )
            {
            // InternalBgDsl.g:911:4: (lv_initialState_20_0= ruleState )
            // InternalBgDsl.g:912:5: lv_initialState_20_0= ruleState
            {
    ...
    // InternalBgDsl.g:937:1: entryRuleLegalMovesPipeline returns [EObject current=null] : iv_ruleLegalMovesPipeline= ruleLegalMovesPipeline EOF ;
    public final EObject entryRuleLegalMovesPipeline() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:937:59: (iv_ruleLegalMovesPipeline= ruleLegalMovesPipeline EOF )
            // InternalBgDsl.g:938:2: iv_ruleLegalMovesPipeline= ruleLegalMovesPipeline EOF
            {
    ...
    // InternalBgDsl.g:944:1: ruleLegalMovesPipeline returns [EObject current=null] : ( () otherlv_1= 'LegalMovesPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}' ) ;
    public final EObject ruleLegalMovesPipeline() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:950:2: ( ( () otherlv_1= 'LegalMovesPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}' ) )
            // InternalBgDsl.g:951:2: ( () otherlv_1= 'LegalMovesPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}' )
            {
            // InternalBgDsl.g:951:2: ( () otherlv_1= 'LegalMovesPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}' )
            // InternalBgDsl.g:952:3: () otherlv_1= 'LegalMovesPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}'
            {
            // InternalBgDsl.g:952:3: ()
            // InternalBgDsl.g:953:4: 
            {
            ...
            // InternalBgDsl.g:967:3: (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalBgDsl.g:968:4: otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}'
                    {
                    ...
                    // InternalBgDsl.g:976:4: ( (lv_filters_5_0= ruleFilter ) )
                    // InternalBgDsl.g:977:5: (lv_filters_5_0= ruleFilter )
                    {
                    // InternalBgDsl.g:977:5: (lv_filters_5_0= ruleFilter )
                    // InternalBgDsl.g:978:6: lv_filters_5_0= ruleFilter
                    {
                    ...
                    // InternalBgDsl.g:995:4: (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )*
                    loop12:
                    do {
                        int alt12=2;
                        ...
                        switch (alt12) {
                    	case 1 :
                    	    // InternalBgDsl.g:996:5: otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) )
                    	    {
                    	    otherlv_6=(Token)match(input,17,FOLLOW_36); 

                    	    					newLeafNode(otherlv_6, grammarAccess.getLegalMovesPipelineAccess().getCommaKeyword_3_3_0());
                    	    				
                    	    // InternalBgDsl.g:1000:5: ( (lv_filters_7_0= ruleFilter ) )
                    	    // InternalBgDsl.g:1001:6: (lv_filters_7_0= ruleFilter )
                    	    {
                    	    // InternalBgDsl.g:1001:6: (lv_filters_7_0= ruleFilter )
                    	    // InternalBgDsl.g:1002:7: lv_filters_7_0= ruleFilter
                    	    {
    ...
    // InternalBgDsl.g:1033:1: entryRuleEffectPipeline returns [EObject current=null] : iv_ruleEffectPipeline= ruleEffectPipeline EOF ;
    public final EObject entryRuleEffectPipeline() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1033:55: (iv_ruleEffectPipeline= ruleEffectPipeline EOF )
            // InternalBgDsl.g:1034:2: iv_ruleEffectPipeline= ruleEffectPipeline EOF
            {
    ...
    // InternalBgDsl.g:1040:1: ruleEffectPipeline returns [EObject current=null] : ( () otherlv_1= 'EffectPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}' ) ;
    public final EObject ruleEffectPipeline() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1046:2: ( ( () otherlv_1= 'EffectPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}' ) )
            // InternalBgDsl.g:1047:2: ( () otherlv_1= 'EffectPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}' )
            {
            // InternalBgDsl.g:1047:2: ( () otherlv_1= 'EffectPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}' )
            // InternalBgDsl.g:1048:3: () otherlv_1= 'EffectPipeline' otherlv_2= '{' (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )? otherlv_9= '}'
            {
            ...
            // InternalBgDsl.g:1063:3: (otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}' )?
            int alt15=2;
            ...
            switch (alt15) {
                case 1 :
                    // InternalBgDsl.g:1064:4: otherlv_3= 'filters' otherlv_4= '{' ( (lv_filters_5_0= ruleFilter ) ) (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )* otherlv_8= '}'
                    {
                    otherlv_3=(Token)match(input,37,FOLLOW_4); 
                    ...
                    // InternalBgDsl.g:1072:4: ( (lv_filters_5_0= ruleFilter ) )
                    // InternalBgDsl.g:1073:5: (lv_filters_5_0= ruleFilter )
                    {
                    // InternalBgDsl.g:1073:5: (lv_filters_5_0= ruleFilter )
                    // InternalBgDsl.g:1074:6: lv_filters_5_0= ruleFilter
                    {
                    ...
                    // InternalBgDsl.g:1091:4: (otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) ) )*
                    loop14:
                    do {
                        int alt14=2;
                        ...
                        switch (alt14) {
                    	case 1 :
                    	    // InternalBgDsl.g:1092:5: otherlv_6= ',' ( (lv_filters_7_0= ruleFilter ) )
                    	    {
                    	    otherlv_6=(Token)match(input,17,FOLLOW_36); 

                    	    					newLeafNode(otherlv_6, grammarAccess.getEffectPipelineAccess().getCommaKeyword_3_3_0());
                    	    				
                    	    // InternalBgDsl.g:1096:5: ( (lv_filters_7_0= ruleFilter ) )
                    	    // InternalBgDsl.g:1097:6: (lv_filters_7_0= ruleFilter )
                    	    {
                    	    // InternalBgDsl.g:1097:6: (lv_filters_7_0= ruleFilter )
                    	    // InternalBgDsl.g:1098:7: lv_filters_7_0= ruleFilter
                    	    {
    ...
    // InternalBgDsl.g:1129:1: entryRuleTilePlacement returns [EObject current=null] : iv_ruleTilePlacement= ruleTilePlacement EOF ;
    public final EObject entryRuleTilePlacement() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1129:54: (iv_ruleTilePlacement= ruleTilePlacement EOF )
            // InternalBgDsl.g:1130:2: iv_ruleTilePlacement= ruleTilePlacement EOF
            {
    ...
    // InternalBgDsl.g:1136:1: ruleTilePlacement returns [EObject current=null] : (otherlv_0= 'TilePlacement' otherlv_1= '{' otherlv_2= 'row' ( (lv_row_3_0= ruleEInt ) ) otherlv_4= 'column' ( (lv_column_5_0= ruleEInt ) ) otherlv_6= 'tile' ( ( ruleEString ) ) (otherlv_8= 'initialState' ( ( ruleEString ) ) )? otherlv_10= '}' ) ;
    public final EObject ruleTilePlacement() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1142:2: ( (otherlv_0= 'TilePlacement' otherlv_1= '{' otherlv_2= 'row' ( (lv_row_3_0= ruleEInt ) ) otherlv_4= 'column' ( (lv_column_5_0= ruleEInt ) ) otherlv_6= 'tile' ( ( ruleEString ) ) (otherlv_8= 'initialState' ( ( ruleEString ) ) )? otherlv_10= '}' ) )
            // InternalBgDsl.g:1143:2: (otherlv_0= 'TilePlacement' otherlv_1= '{' otherlv_2= 'row' ( (lv_row_3_0= ruleEInt ) ) otherlv_4= 'column' ( (lv_column_5_0= ruleEInt ) ) otherlv_6= 'tile' ( ( ruleEString ) ) (otherlv_8= 'initialState' ( ( ruleEString ) ) )? otherlv_10= '}' )
            {
            // InternalBgDsl.g:1143:2: (otherlv_0= 'TilePlacement' otherlv_1= '{' otherlv_2= 'row' ( (lv_row_3_0= ruleEInt ) ) otherlv_4= 'column' ( (lv_column_5_0= ruleEInt ) ) otherlv_6= 'tile' ( ( ruleEString ) ) (otherlv_8= 'initialState' ( ( ruleEString ) ) )? otherlv_10= '}' )
            // InternalBgDsl.g:1144:3: otherlv_0= 'TilePlacement' otherlv_1= '{' otherlv_2= 'row' ( (lv_row_3_0= ruleEInt ) ) otherlv_4= 'column' ( (lv_column_5_0= ruleEInt ) ) otherlv_6= 'tile' ( ( ruleEString ) ) (otherlv_8= 'initialState' ( ( ruleEString ) ) )? otherlv_10= '}'
            {
            ...
            // InternalBgDsl.g:1156:3: ( (lv_row_3_0= ruleEInt ) )
            // InternalBgDsl.g:1157:4: (lv_row_3_0= ruleEInt )
            {
            // InternalBgDsl.g:1157:4: (lv_row_3_0= ruleEInt )
            // InternalBgDsl.g:1158:5: lv_row_3_0= ruleEInt
            {
            ...
            // InternalBgDsl.g:1179:3: ( (lv_column_5_0= ruleEInt ) )
            // InternalBgDsl.g:1180:4: (lv_column_5_0= ruleEInt )
            {
            // InternalBgDsl.g:1180:4: (lv_column_5_0= ruleEInt )
            // InternalBgDsl.g:1181:5: lv_column_5_0= ruleEInt
            {
            ...
            // InternalBgDsl.g:1202:3: ( ( ruleEString ) )
            // InternalBgDsl.g:1203:4: ( ruleEString )
            {
            // InternalBgDsl.g:1203:4: ( ruleEString )
            // InternalBgDsl.g:1204:5: ruleEString
            {
            ...
            // InternalBgDsl.g:1218:3: (otherlv_8= 'initialState' ( ( ruleEString ) ) )?
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // InternalBgDsl.g:1219:4: otherlv_8= 'initialState' ( ( ruleEString ) )
                    {
                    ...
                    // InternalBgDsl.g:1223:4: ( ( ruleEString ) )
                    // InternalBgDsl.g:1224:5: ( ruleEString )
                    {
                    // InternalBgDsl.g:1224:5: ( ruleEString )
                    // InternalBgDsl.g:1225:6: ruleEString
                    {
    ...
    // InternalBgDsl.g:1248:1: entryRuleState returns [EObject current=null] : iv_ruleState= ruleState EOF ;
    public final EObject entryRuleState() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1248:46: (iv_ruleState= ruleState EOF )
            // InternalBgDsl.g:1249:2: iv_ruleState= ruleState EOF
            {
    ...
    public final EObject ruleState() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1261:2: ( (otherlv_0= 'State' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) (otherlv_5= 'outbound' otherlv_6= '(' ( ( ruleEString ) ) (otherlv_8= ',' ( ( ruleEString ) ) )* otherlv_10= ')' )? (otherlv_11= 'inbound' otherlv_12= '(' ( ( ruleEString ) ) (otherlv_14= ',' ( ( ruleEString ) ) )* otherlv_16= ')' )? otherlv_17= '}' ) )
            // InternalBgDsl.g:1262:2: (otherlv_0= 'State' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) (otherlv_5= 'outbound' otherlv_6= '(' ( ( ruleEString ) ) (otherlv_8= ',' ( ( ruleEString ) ) )* otherlv_10= ')' )? (otherlv_11= 'inbound' otherlv_12= '(' ( ( ruleEString ) ) (otherlv_14= ',' ( ( ruleEString ) ) )* otherlv_16= ')' )? otherlv_17= '}' )
            {
            // InternalBgDsl.g:1262:2: (otherlv_0= 'State' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) (otherlv_5= 'outbound' otherlv_6= '(' ( ( ruleEString ) ) (otherlv_8= ',' ( ( ruleEString ) ) )* otherlv_10= ')' )? (otherlv_11= 'inbound' otherlv_12= '(' ( ( ruleEString ) ) (otherlv_14= ',' ( ( ruleEString ) ) )* otherlv_16= ')' )? otherlv_17= '}' )
            // InternalBgDsl.g:1263:3: otherlv_0= 'State' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'hexColor' ( (lv_hexColor_4_0= ruleEString ) ) (otherlv_5= 'outbound' otherlv_6= '(' ( ( ruleEString ) ) (otherlv_8= ',' ( ( ruleEString ) ) )* otherlv_10= ')' )? (otherlv_11= 'inbound' otherlv_12= '(' ( ( ruleEString ) ) (otherlv_14= ',' ( ( ruleEString ) ) )* otherlv_16= ')' )? otherlv_17= '}'
            {
            otherlv_0=(Token)match(input,43,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getStateAccess().getStateKeyword_0());
            		
            // InternalBgDsl.g:1267:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBgDsl.g:1268:4: (lv_name_1_0= ruleEString )
            {
            // InternalBgDsl.g:1268:4: (lv_name_1_0= ruleEString )
            // InternalBgDsl.g:1269:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalBgDsl.g:1294:3: ( (lv_hexColor_4_0= ruleEString ) )
            // InternalBgDsl.g:1295:4: (lv_hexColor_4_0= ruleEString )
            {
            // InternalBgDsl.g:1295:4: (lv_hexColor_4_0= ruleEString )
            // InternalBgDsl.g:1296:5: lv_hexColor_4_0= ruleEString
            {
            ...
            // InternalBgDsl.g:1313:3: (otherlv_5= 'outbound' otherlv_6= '(' ( ( ruleEString ) ) (otherlv_8= ',' ( ( ruleEString ) ) )* otherlv_10= ')' )?
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalBgDsl.g:1314:4: otherlv_5= 'outbound' otherlv_6= '(' ( ( ruleEString ) ) (otherlv_8= ',' ( ( ruleEString ) ) )* otherlv_10= ')'
                    {
                    ...
                    // InternalBgDsl.g:1322:4: ( ( ruleEString ) )
                    // InternalBgDsl.g:1323:5: ( ruleEString )
                    {
                    // InternalBgDsl.g:1323:5: ( ruleEString )
                    // InternalBgDsl.g:1324:6: ruleEString
                    {
                    ...
                    // InternalBgDsl.g:1338:4: (otherlv_8= ',' ( ( ruleEString ) ) )*
                    loop17:
                    do {
                        int alt17=2;
                        ...
                        switch (alt17) {
                    	case 1 :
                    	    // InternalBgDsl.g:1339:5: otherlv_8= ',' ( ( ruleEString ) )
                    	    {
                    	    otherlv_8=(Token)match(input,17,FOLLOW_3); 

                    	    					newLeafNode(otherlv_8, grammarAccess.getStateAccess().getCommaKeyword_5_3_0());
                    	    				
                    	    // InternalBgDsl.g:1343:5: ( ( ruleEString ) )
                    	    // InternalBgDsl.g:1344:6: ( ruleEString )
                    	    {
                    	    // InternalBgDsl.g:1344:6: ( ruleEString )
                    	    // InternalBgDsl.g:1345:7: ruleEString
                    	    {
                    ...
                    otherlv_10=(Token)match(input,46,FOLLOW_44); 
            ...
            // InternalBgDsl.g:1365:3: (otherlv_11= 'inbound' otherlv_12= '(' ( ( ruleEString ) ) (otherlv_14= ',' ( ( ruleEString ) ) )* otherlv_16= ')' )?
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    // InternalBgDsl.g:1366:4: otherlv_11= 'inbound' otherlv_12= '(' ( ( ruleEString ) ) (otherlv_14= ',' ( ( ruleEString ) ) )* otherlv_16= ')'
                    {
                    ...
                    // InternalBgDsl.g:1374:4: ( ( ruleEString ) )
                    // InternalBgDsl.g:1375:5: ( ruleEString )
                    {
                    // InternalBgDsl.g:1375:5: ( ruleEString )
                    // InternalBgDsl.g:1376:6: ruleEString
                    {
                    ...
                    // InternalBgDsl.g:1390:4: (otherlv_14= ',' ( ( ruleEString ) ) )*
                    loop19:
                    do {
                        int alt19=2;
                        ...
                        switch (alt19) {
                    	case 1 :
                    	    // InternalBgDsl.g:1391:5: otherlv_14= ',' ( ( ruleEString ) )
                    	    {
                    	    otherlv_14=(Token)match(input,17,FOLLOW_3); 

                    	    					newLeafNode(otherlv_14, grammarAccess.getStateAccess().getCommaKeyword_6_3_0());
                    	    				
                    	    // InternalBgDsl.g:1395:5: ( ( ruleEString ) )
                    	    // InternalBgDsl.g:1396:6: ( ruleEString )
                    	    {
                    	    // InternalBgDsl.g:1396:6: ( ruleEString )
                    	    // InternalBgDsl.g:1397:7: ruleEString
                    	    {
    ...
    // InternalBgDsl.g:1425:1: entryRuleTransition returns [EObject current=null] : iv_ruleTransition= ruleTransition EOF ;
    public final EObject entryRuleTransition() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1425:51: (iv_ruleTransition= ruleTransition EOF )
            // InternalBgDsl.g:1426:2: iv_ruleTransition= ruleTransition EOF
            {
    ...
    // InternalBgDsl.g:1432:1: ruleTransition returns [EObject current=null] : (otherlv_0= 'Transition' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'source' otherlv_4= '(' ( ( ruleEString ) ) (otherlv_6= ',' ( ( ruleEString ) ) )* otherlv_8= ')' otherlv_9= 'target' ( ( ruleEString ) ) otherlv_11= '}' ) ;
    public final EObject ruleTransition() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1438:2: ( (otherlv_0= 'Transition' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'source' otherlv_4= '(' ( ( ruleEString ) ) (otherlv_6= ',' ( ( ruleEString ) ) )* otherlv_8= ')' otherlv_9= 'target' ( ( ruleEString ) ) otherlv_11= '}' ) )
            // InternalBgDsl.g:1439:2: (otherlv_0= 'Transition' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'source' otherlv_4= '(' ( ( ruleEString ) ) (otherlv_6= ',' ( ( ruleEString ) ) )* otherlv_8= ')' otherlv_9= 'target' ( ( ruleEString ) ) otherlv_11= '}' )
            {
            // InternalBgDsl.g:1439:2: (otherlv_0= 'Transition' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'source' otherlv_4= '(' ( ( ruleEString ) ) (otherlv_6= ',' ( ( ruleEString ) ) )* otherlv_8= ')' otherlv_9= 'target' ( ( ruleEString ) ) otherlv_11= '}' )
            // InternalBgDsl.g:1440:3: otherlv_0= 'Transition' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'source' otherlv_4= '(' ( ( ruleEString ) ) (otherlv_6= ',' ( ( ruleEString ) ) )* otherlv_8= ')' otherlv_9= 'target' ( ( ruleEString ) ) otherlv_11= '}'
            {
            otherlv_0=(Token)match(input,48,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getTransitionAccess().getTransitionKeyword_0());
            		
            // InternalBgDsl.g:1444:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBgDsl.g:1445:4: (lv_name_1_0= ruleEString )
            {
            // InternalBgDsl.g:1445:4: (lv_name_1_0= ruleEString )
            // InternalBgDsl.g:1446:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalBgDsl.g:1475:3: ( ( ruleEString ) )
            // InternalBgDsl.g:1476:4: ( ruleEString )
            {
            // InternalBgDsl.g:1476:4: ( ruleEString )
            // InternalBgDsl.g:1477:5: ruleEString
            {
            ...
            // InternalBgDsl.g:1491:3: (otherlv_6= ',' ( ( ruleEString ) ) )*
            loop21:
            do {
                int alt21=2;
                ...
                switch (alt21) {
            	case 1 :
            	    // InternalBgDsl.g:1492:4: otherlv_6= ',' ( ( ruleEString ) )
            	    {
            	    otherlv_6=(Token)match(input,17,FOLLOW_3); 

            	    				newLeafNode(otherlv_6, grammarAccess.getTransitionAccess().getCommaKeyword_6_0());
            	    			
            	    // InternalBgDsl.g:1496:4: ( ( ruleEString ) )
            	    // InternalBgDsl.g:1497:5: ( ruleEString )
            	    {
            	    // InternalBgDsl.g:1497:5: ( ruleEString )
            	    // InternalBgDsl.g:1498:6: ruleEString
            	    {
            ...
            // InternalBgDsl.g:1521:3: ( ( ruleEString ) )
            // InternalBgDsl.g:1522:4: ( ruleEString )
            {
            // InternalBgDsl.g:1522:4: ( ruleEString )
            // InternalBgDsl.g:1523:5: ruleEString
            {
    ...
    // InternalBgDsl.g:1545:1: entryRulePatternFilter returns [EObject current=null] : iv_rulePatternFilter= rulePatternFilter EOF ;
    public final EObject entryRulePatternFilter() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1545:54: (iv_rulePatternFilter= rulePatternFilter EOF )
            // InternalBgDsl.g:1546:2: iv_rulePatternFilter= rulePatternFilter EOF
            {
    ...
    // InternalBgDsl.g:1552:1: rulePatternFilter returns [EObject current=null] : (otherlv_0= 'PatternFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}' ) ;
    public final EObject rulePatternFilter() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1558:2: ( (otherlv_0= 'PatternFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}' ) )
            // InternalBgDsl.g:1559:2: (otherlv_0= 'PatternFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}' )
            {
            // InternalBgDsl.g:1559:2: (otherlv_0= 'PatternFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}' )
            // InternalBgDsl.g:1560:3: otherlv_0= 'PatternFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}'
            {
            ...
            // InternalBgDsl.g:1564:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBgDsl.g:1565:4: (lv_name_1_0= ruleEString )
            {
            // InternalBgDsl.g:1565:4: (lv_name_1_0= ruleEString )
            // InternalBgDsl.g:1566:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalBgDsl.g:1587:3: (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )?
            int alt22=2;
            ...
            switch (alt22) {
                case 1 :
                    // InternalBgDsl.g:1588:4: otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) )
                    {
                    ...
                    // InternalBgDsl.g:1592:4: ( (lv_nextFilter_4_0= ruleFilter ) )
                    // InternalBgDsl.g:1593:5: (lv_nextFilter_4_0= ruleFilter )
                    {
                    // InternalBgDsl.g:1593:5: (lv_nextFilter_4_0= ruleFilter )
                    // InternalBgDsl.g:1594:6: lv_nextFilter_4_0= ruleFilter
                    {
            ...
            // InternalBgDsl.g:1620:3: ( (lv_patterns_7_0= rulePattern ) )
            // InternalBgDsl.g:1621:4: (lv_patterns_7_0= rulePattern )
            {
            // InternalBgDsl.g:1621:4: (lv_patterns_7_0= rulePattern )
            // InternalBgDsl.g:1622:5: lv_patterns_7_0= rulePattern
            {
            ...
            // InternalBgDsl.g:1639:3: (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )*
            loop23:
            do {
                int alt23=2;
                ...
                switch (alt23) {
            	case 1 :
            	    // InternalBgDsl.g:1640:4: otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) )
            	    {
            	    otherlv_8=(Token)match(input,17,FOLLOW_49); 

            	    				newLeafNode(otherlv_8, grammarAccess.getPatternFilterAccess().getCommaKeyword_7_0());
            	    			
            	    // InternalBgDsl.g:1644:4: ( (lv_patterns_9_0= rulePattern ) )
            	    // InternalBgDsl.g:1645:5: (lv_patterns_9_0= rulePattern )
            	    {
            	    // InternalBgDsl.g:1645:5: (lv_patterns_9_0= rulePattern )
            	    // InternalBgDsl.g:1646:6: lv_patterns_9_0= rulePattern
            	    {
    ...
    // InternalBgDsl.g:1676:1: entryRuleIterativeFilter returns [EObject current=null] : iv_ruleIterativeFilter= ruleIterativeFilter EOF ;
    public final EObject entryRuleIterativeFilter() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1676:56: (iv_ruleIterativeFilter= ruleIterativeFilter EOF )
            // InternalBgDsl.g:1677:2: iv_ruleIterativeFilter= ruleIterativeFilter EOF
            {
    ...
    // InternalBgDsl.g:1683:1: ruleIterativeFilter returns [EObject current=null] : (otherlv_0= 'IterativeFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'directionVectors' otherlv_6= '{' ( (lv_directionVectors_7_0= ruleRelativeCoordinate ) ) (otherlv_8= ',' ( (lv_directionVectors_9_0= ruleRelativeCoordinate ) ) )* otherlv_10= '}' otherlv_11= 'matchRule' ( (lv_matchRule_12_0= rulePattern ) ) otherlv_13= 'endRule' ( (lv_endRule_14_0= rulePattern ) ) otherlv_15= '}' ) ;
    public final EObject ruleIterativeFilter() throws RecognitionException {
        ...
        EObject lv_directionVectors_7_0 = null;

        EObject lv_directionVectors_9_0 = null;

        EObject lv_matchRule_12_0 = null;

        EObject lv_endRule_14_0 = null;
        ...
        try {
            // InternalBgDsl.g:1689:2: ( (otherlv_0= 'IterativeFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'directionVectors' otherlv_6= '{' ( (lv_directionVectors_7_0= ruleRelativeCoordinate ) ) (otherlv_8= ',' ( (lv_directionVectors_9_0= ruleRelativeCoordinate ) ) )* otherlv_10= '}' otherlv_11= 'matchRule' ( (lv_matchRule_12_0= rulePattern ) ) otherlv_13= 'endRule' ( (lv_endRule_14_0= rulePattern ) ) otherlv_15= '}' ) )
            // InternalBgDsl.g:1690:2: (otherlv_0= 'IterativeFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'directionVectors' otherlv_6= '{' ( (lv_directionVectors_7_0= ruleRelativeCoordinate ) ) (otherlv_8= ',' ( (lv_directionVectors_9_0= ruleRelativeCoordinate ) ) )* otherlv_10= '}' otherlv_11= 'matchRule' ( (lv_matchRule_12_0= rulePattern ) ) otherlv_13= 'endRule' ( (lv_endRule_14_0= rulePattern ) ) otherlv_15= '}' )
            {
            // InternalBgDsl.g:1690:2: (otherlv_0= 'IterativeFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'directionVectors' otherlv_6= '{' ( (lv_directionVectors_7_0= ruleRelativeCoordinate ) ) (otherlv_8= ',' ( (lv_directionVectors_9_0= ruleRelativeCoordinate ) ) )* otherlv_10= '}' otherlv_11= 'matchRule' ( (lv_matchRule_12_0= rulePattern ) ) otherlv_13= 'endRule' ( (lv_endRule_14_0= rulePattern ) ) otherlv_15= '}' )
            // InternalBgDsl.g:1691:3: otherlv_0= 'IterativeFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'directionVectors' otherlv_6= '{' ( (lv_directionVectors_7_0= ruleRelativeCoordinate ) ) (otherlv_8= ',' ( (lv_directionVectors_9_0= ruleRelativeCoordinate ) ) )* otherlv_10= '}' otherlv_11= 'matchRule' ( (lv_matchRule_12_0= rulePattern ) ) otherlv_13= 'endRule' ( (lv_endRule_14_0= rulePattern ) ) otherlv_15= '}'
            {
            ...
            // InternalBgDsl.g:1695:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBgDsl.g:1696:4: (lv_name_1_0= ruleEString )
            {
            // InternalBgDsl.g:1696:4: (lv_name_1_0= ruleEString )
            // InternalBgDsl.g:1697:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalBgDsl.g:1718:3: (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )?
            int alt24=2;
            ...
            switch (alt24) {
                case 1 :
                    // InternalBgDsl.g:1719:4: otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) )
                    {
                    otherlv_3=(Token)match(input,52,FOLLOW_36); 

                    				newLeafNode(otherlv_3, grammarAccess.getIterativeFilterAccess().getNextFilterKeyword_3_0());
                    			
                    // InternalBgDsl.g:1723:4: ( (lv_nextFilter_4_0= ruleFilter ) )
                    // InternalBgDsl.g:1724:5: (lv_nextFilter_4_0= ruleFilter )
                    {
                    // InternalBgDsl.g:1724:5: (lv_nextFilter_4_0= ruleFilter )
                    // InternalBgDsl.g:1725:6: lv_nextFilter_4_0= ruleFilter
                    {
            ...
            otherlv_5=(Token)match(input,55,FOLLOW_4); 
            			...
            			newLeafNode(otherlv_5, grammarAccess.getIterativeFilterAccess().getDirectionVectorsKeyword_4());
            		
            otherlv_6=(Token)match(input,12,FOLLOW_52); 

            			newLeafNode(otherlv_6, grammarAccess.getIterativeFilterAccess().getLeftCurlyBracketKeyword_5());
            		
            // InternalBgDsl.g:1751:3: ( (lv_directionVectors_7_0= ruleRelativeCoordinate ) )
            // InternalBgDsl.g:1752:4: (lv_directionVectors_7_0= ruleRelativeCoordinate )
            {
            // InternalBgDsl.g:1752:4: (lv_directionVectors_7_0= ruleRelativeCoordinate )
            // InternalBgDsl.g:1753:5: lv_directionVectors_7_0= ruleRelativeCoordinate
            {

            					newCompositeNode(grammarAccess.getIterativeFilterAccess().getDirectionVectorsRelativeCoordinateParserRuleCall_6_0());
            				
            pushFollow(FOLLOW_12);
            lv_directionVectors_7_0=ruleRelativeCoordinate();
            ...
            // InternalBgDsl.g:1770:3: (otherlv_8= ',' ( (lv_directionVectors_9_0= ruleRelativeCoordinate ) ) )*
            loop25:
            do {
                int alt25=2;
                ...
                switch (alt25) {
            	case 1 :
            	    // InternalBgDsl.g:1771:4: otherlv_8= ',' ( (lv_directionVectors_9_0= ruleRelativeCoordinate ) )
            	    {
            	    otherlv_8=(Token)match(input,17,FOLLOW_52); 

            	    				newLeafNode(otherlv_8, grammarAccess.getIterativeFilterAccess().getCommaKeyword_7_0());
            	    			
            	    // InternalBgDsl.g:1775:4: ( (lv_directionVectors_9_0= ruleRelativeCoordinate ) )
            	    // InternalBgDsl.g:1776:5: (lv_directionVectors_9_0= ruleRelativeCoordinate )
            	    {
            	    // InternalBgDsl.g:1776:5: (lv_directionVectors_9_0= ruleRelativeCoordinate )
            	    // InternalBgDsl.g:1777:6: lv_directionVectors_9_0= ruleRelativeCoordinate
            	    {

            	    						newCompositeNode(grammarAccess.getIterativeFilterAccess().getDirectionVectorsRelativeCoordinateParserRuleCall_7_1_0());
            	    					
            	    pushFollow(FOLLOW_12);
            	    lv_directionVectors_9_0=ruleRelativeCoordinate();
            ...
            otherlv_10=(Token)match(input,18,FOLLOW_53); 
            			...
            			newLeafNode(otherlv_10, grammarAccess.getIterativeFilterAccess().getRightCurlyBracketKeyword_8());
            		
            otherlv_11=(Token)match(input,56,FOLLOW_49); 

            			newLeafNode(otherlv_11, grammarAccess.getIterativeFilterAccess().getMatchRuleKeyword_9());
            		
            // InternalBgDsl.g:1803:3: ( (lv_matchRule_12_0= rulePattern ) )
            // InternalBgDsl.g:1804:4: (lv_matchRule_12_0= rulePattern )
            {
            // InternalBgDsl.g:1804:4: (lv_matchRule_12_0= rulePattern )
            // InternalBgDsl.g:1805:5: lv_matchRule_12_0= rulePattern
            {

            					newCompositeNode(grammarAccess.getIterativeFilterAccess().getMatchRulePatternParserRuleCall_10_0());
            				
            pushFollow(FOLLOW_54);
            lv_matchRule_12_0=rulePattern();
            ...
            otherlv_13=(Token)match(input,57,FOLLOW_49); 

            			newLeafNode(otherlv_13, grammarAccess.getIterativeFilterAccess().getEndRuleKeyword_11());
            		
            // InternalBgDsl.g:1826:3: ( (lv_endRule_14_0= rulePattern ) )
            // InternalBgDsl.g:1827:4: (lv_endRule_14_0= rulePattern )
            {
            // InternalBgDsl.g:1827:4: (lv_endRule_14_0= rulePattern )
            // InternalBgDsl.g:1828:5: lv_endRule_14_0= rulePattern
            {

            					newCompositeNode(grammarAccess.getIterativeFilterAccess().getEndRulePatternParserRuleCall_12_0());
            				
            pushFollow(FOLLOW_13);
            lv_endRule_14_0=rulePattern();
            ...
            otherlv_15=(Token)match(input,18,FOLLOW_2); 
            			...
            			newLeafNode(otherlv_15, grammarAccess.getIterativeFilterAccess().getRightCurlyBracketKeyword_13());
    ...
    // InternalBgDsl.g:1853:1: entryRuleStateEffectFilter returns [EObject current=null] : iv_ruleStateEffectFilter= ruleStateEffectFilter EOF ;
    public final EObject entryRuleStateEffectFilter() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1853:58: (iv_ruleStateEffectFilter= ruleStateEffectFilter EOF )
            // InternalBgDsl.g:1854:2: iv_ruleStateEffectFilter= ruleStateEffectFilter EOF
            {
    ...
    // InternalBgDsl.g:1860:1: ruleStateEffectFilter returns [EObject current=null] : (otherlv_0= 'StateEffectFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) (otherlv_5= 'targetState' ( ( ruleEString ) ) )? (otherlv_7= 'nextFilter' ( (lv_nextFilter_8_0= ruleFilter ) ) )? otherlv_9= '}' ) ;
    public final EObject ruleStateEffectFilter() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:1866:2: ( (otherlv_0= 'StateEffectFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) (otherlv_5= 'targetState' ( ( ruleEString ) ) )? (otherlv_7= 'nextFilter' ( (lv_nextFilter_8_0= ruleFilter ) ) )? otherlv_9= '}' ) )
            // InternalBgDsl.g:1867:2: (otherlv_0= 'StateEffectFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) (otherlv_5= 'targetState' ( ( ruleEString ) ) )? (otherlv_7= 'nextFilter' ( (lv_nextFilter_8_0= ruleFilter ) ) )? otherlv_9= '}' )
            {
            // InternalBgDsl.g:1867:2: (otherlv_0= 'StateEffectFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) (otherlv_5= 'targetState' ( ( ruleEString ) ) )? (otherlv_7= 'nextFilter' ( (lv_nextFilter_8_0= ruleFilter ) ) )? otherlv_9= '}' )
            // InternalBgDsl.g:1868:3: otherlv_0= 'StateEffectFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) (otherlv_5= 'targetState' ( ( ruleEString ) ) )? (otherlv_7= 'nextFilter' ( (lv_nextFilter_8_0= ruleFilter ) ) )? otherlv_9= '}'
            {
            ...
            // InternalBgDsl.g:1872:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBgDsl.g:1873:4: (lv_name_1_0= ruleEString )
            {
            // InternalBgDsl.g:1873:4: (lv_name_1_0= ruleEString )
            // InternalBgDsl.g:1874:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalBgDsl.g:1899:3: ( (lv_stateSelection_4_0= ruleStateSelection ) )
            // InternalBgDsl.g:1900:4: (lv_stateSelection_4_0= ruleStateSelection )
            {
            // InternalBgDsl.g:1900:4: (lv_stateSelection_4_0= ruleStateSelection )
            // InternalBgDsl.g:1901:5: lv_stateSelection_4_0= ruleStateSelection
            {
            ...
            // InternalBgDsl.g:1918:3: (otherlv_5= 'targetState' ( ( ruleEString ) ) )?
            int alt26=2;
            ...
            switch (alt26) {
                case 1 :
                    // InternalBgDsl.g:1919:4: otherlv_5= 'targetState' ( ( ruleEString ) )
                    {
                    ...
                    // InternalBgDsl.g:1923:4: ( ( ruleEString ) )
                    // InternalBgDsl.g:1924:5: ( ruleEString )
                    {
                    // InternalBgDsl.g:1924:5: ( ruleEString )
                    // InternalBgDsl.g:1925:6: ruleEString
                    {
            ...
            // InternalBgDsl.g:1940:3: (otherlv_7= 'nextFilter' ( (lv_nextFilter_8_0= ruleFilter ) ) )?
            int alt27=2;
            ...
            switch (alt27) {
                case 1 :
                    // InternalBgDsl.g:1941:4: otherlv_7= 'nextFilter' ( (lv_nextFilter_8_0= ruleFilter ) )
                    {
                    ...
                    // InternalBgDsl.g:1945:4: ( (lv_nextFilter_8_0= ruleFilter ) )
                    // InternalBgDsl.g:1946:5: (lv_nextFilter_8_0= ruleFilter )
                    {
                    // InternalBgDsl.g:1946:5: (lv_nextFilter_8_0= ruleFilter )
                    // InternalBgDsl.g:1947:6: lv_nextFilter_8_0= ruleFilter
                    {
    ...
    // InternalBgDsl.g:1973:1: entryRuleWinConditionFilter returns [EObject current=null] : iv_ruleWinConditionFilter= ruleWinConditionFilter EOF ;
    public final EObject entryRuleWinConditionFilter() throws RecognitionException {
        EObject current = null;

        EObject iv_ruleWinConditionFilter = null;


        try {
            // InternalBgDsl.g:1973:59: (iv_ruleWinConditionFilter= ruleWinConditionFilter EOF )
            // InternalBgDsl.g:1974:2: iv_ruleWinConditionFilter= ruleWinConditionFilter EOF
            {
            ...
            state._fsp--;
             ...
             current =iv_ruleWinConditionFilter; 
            match(input,EOF,FOLLOW_2); 
    ...
    // InternalBgDsl.g:1980:1: ruleWinConditionFilter returns [EObject current=null] : (otherlv_0= 'WinConditionFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}' ) ;
    public final EObject ruleWinConditionFilter() throws RecognitionException {
        EObject current = null;
        ...
        try {
            // InternalBgDsl.g:1986:2: ( (otherlv_0= 'WinConditionFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}' ) )
            // InternalBgDsl.g:1987:2: (otherlv_0= 'WinConditionFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}' )
            {
            // InternalBgDsl.g:1987:2: (otherlv_0= 'WinConditionFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}' )
            // InternalBgDsl.g:1988:3: otherlv_0= 'WinConditionFilter' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )? otherlv_5= 'patterns' otherlv_6= '{' ( (lv_patterns_7_0= rulePattern ) ) (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )* otherlv_10= '}' otherlv_11= '}'
            {
            ...
            // InternalBgDsl.g:1992:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBgDsl.g:1993:4: (lv_name_1_0= ruleEString )
            {
            // InternalBgDsl.g:1993:4: (lv_name_1_0= ruleEString )
            // InternalBgDsl.g:1994:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalBgDsl.g:2015:3: (otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) ) )?
            int alt28=2;
            ...
            switch (alt28) {
                case 1 :
                    // InternalBgDsl.g:2016:4: otherlv_3= 'nextFilter' ( (lv_nextFilter_4_0= ruleFilter ) )
                    {
                    otherlv_3=(Token)match(input,52,FOLLOW_36); 

                    				newLeafNode(otherlv_3, grammarAccess.getWinConditionFilterAccess().getNextFilterKeyword_3_0());
                    			
                    // InternalBgDsl.g:2020:4: ( (lv_nextFilter_4_0= ruleFilter ) )
                    // InternalBgDsl.g:2021:5: (lv_nextFilter_4_0= ruleFilter )
                    {
                    // InternalBgDsl.g:2021:5: (lv_nextFilter_4_0= ruleFilter )
                    // InternalBgDsl.g:2022:6: lv_nextFilter_4_0= ruleFilter
                    {
            ...
            // InternalBgDsl.g:2048:3: ( (lv_patterns_7_0= rulePattern ) )
            // InternalBgDsl.g:2049:4: (lv_patterns_7_0= rulePattern )
            {
            // InternalBgDsl.g:2049:4: (lv_patterns_7_0= rulePattern )
            // InternalBgDsl.g:2050:5: lv_patterns_7_0= rulePattern
            {
            ...
            // InternalBgDsl.g:2067:3: (otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) ) )*
            loop29:
            do {
                int alt29=2;
                ...
                switch (alt29) {
            	case 1 :
            	    // InternalBgDsl.g:2068:4: otherlv_8= ',' ( (lv_patterns_9_0= rulePattern ) )
            	    {
            	    otherlv_8=(Token)match(input,17,FOLLOW_49); 

            	    				newLeafNode(otherlv_8, grammarAccess.getWinConditionFilterAccess().getCommaKeyword_7_0());
            	    			
            	    // InternalBgDsl.g:2072:4: ( (lv_patterns_9_0= rulePattern ) )
            	    // InternalBgDsl.g:2073:5: (lv_patterns_9_0= rulePattern )
            	    {
            	    // InternalBgDsl.g:2073:5: (lv_patterns_9_0= rulePattern )
            	    // InternalBgDsl.g:2074:6: lv_patterns_9_0= rulePattern
            	    {
    ...
    // InternalBgDsl.g:2104:1: entryRulePattern returns [EObject current=null] : iv_rulePattern= rulePattern EOF ;
    public final EObject entryRulePattern() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:2104:48: (iv_rulePattern= rulePattern EOF )
            // InternalBgDsl.g:2105:2: iv_rulePattern= rulePattern EOF
            {
    ...
    public final EObject rulePattern() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:2117:2: ( (otherlv_0= 'Pattern' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) )? (otherlv_5= 'matchState' ( ( ruleEString ) ) )? otherlv_7= 'relativecoordinates' otherlv_8= '{' ( (lv_relativecoordinates_9_0= ruleRelativeCoordinate ) ) (otherlv_10= ',' ( (lv_relativecoordinates_11_0= ruleRelativeCoordinate ) ) )* otherlv_12= '}' otherlv_13= '}' ) )
            // InternalBgDsl.g:2118:2: (otherlv_0= 'Pattern' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) )? (otherlv_5= 'matchState' ( ( ruleEString ) ) )? otherlv_7= 'relativecoordinates' otherlv_8= '{' ( (lv_relativecoordinates_9_0= ruleRelativeCoordinate ) ) (otherlv_10= ',' ( (lv_relativecoordinates_11_0= ruleRelativeCoordinate ) ) )* otherlv_12= '}' otherlv_13= '}' )
            {
            // InternalBgDsl.g:2118:2: (otherlv_0= 'Pattern' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) )? (otherlv_5= 'matchState' ( ( ruleEString ) ) )? otherlv_7= 'relativecoordinates' otherlv_8= '{' ( (lv_relativecoordinates_9_0= ruleRelativeCoordinate ) ) (otherlv_10= ',' ( (lv_relativecoordinates_11_0= ruleRelativeCoordinate ) ) )* otherlv_12= '}' otherlv_13= '}' )
            // InternalBgDsl.g:2119:3: otherlv_0= 'Pattern' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' (otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) )? (otherlv_5= 'matchState' ( ( ruleEString ) ) )? otherlv_7= 'relativecoordinates' otherlv_8= '{' ( (lv_relativecoordinates_9_0= ruleRelativeCoordinate ) ) (otherlv_10= ',' ( (lv_relativecoordinates_11_0= ruleRelativeCoordinate ) ) )* otherlv_12= '}' otherlv_13= '}'
            {
            otherlv_0=(Token)match(input,62,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getPatternAccess().getPatternKeyword_0());
            		
            // InternalBgDsl.g:2123:3: ( (lv_name_1_0= ruleEString ) )
            // InternalBgDsl.g:2124:4: (lv_name_1_0= ruleEString )
            {
            // InternalBgDsl.g:2124:4: (lv_name_1_0= ruleEString )
            // InternalBgDsl.g:2125:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalBgDsl.g:2146:3: (otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) ) )?
            int alt30=2;
            ...
            switch (alt30) {
                case 1 :
                    // InternalBgDsl.g:2147:4: otherlv_3= 'stateSelection' ( (lv_stateSelection_4_0= ruleStateSelection ) )
                    {
                    otherlv_3=(Token)match(input,59,FOLLOW_56); 

                    				newLeafNode(otherlv_3, grammarAccess.getPatternAccess().getStateSelectionKeyword_3_0());
                    			
                    // InternalBgDsl.g:2151:4: ( (lv_stateSelection_4_0= ruleStateSelection ) )
                    // InternalBgDsl.g:2152:5: (lv_stateSelection_4_0= ruleStateSelection )
                    {
                    // InternalBgDsl.g:2152:5: (lv_stateSelection_4_0= ruleStateSelection )
                    // InternalBgDsl.g:2153:6: lv_stateSelection_4_0= ruleStateSelection
                    {
            ...
            // InternalBgDsl.g:2171:3: (otherlv_5= 'matchState' ( ( ruleEString ) ) )?
            int alt31=2;
            ...
            switch (alt31) {
                case 1 :
                    // InternalBgDsl.g:2172:4: otherlv_5= 'matchState' ( ( ruleEString ) )
                    {
                    otherlv_5=(Token)match(input,63,FOLLOW_3); 

                    				newLeafNode(otherlv_5, grammarAccess.getPatternAccess().getMatchStateKeyword_4_0());
                    			
                    // InternalBgDsl.g:2176:4: ( ( ruleEString ) )
                    // InternalBgDsl.g:2177:5: ( ruleEString )
                    {
                    // InternalBgDsl.g:2177:5: ( ruleEString )
                    // InternalBgDsl.g:2178:6: ruleEString
                    {
            ...
            // InternalBgDsl.g:2201:3: ( (lv_relativecoordinates_9_0= ruleRelativeCoordinate ) )
            // InternalBgDsl.g:2202:4: (lv_relativecoordinates_9_0= ruleRelativeCoordinate )
            {
            // InternalBgDsl.g:2202:4: (lv_relativecoordinates_9_0= ruleRelativeCoordinate )
            // InternalBgDsl.g:2203:5: lv_relativecoordinates_9_0= ruleRelativeCoordinate
            {
            ...
            // InternalBgDsl.g:2220:3: (otherlv_10= ',' ( (lv_relativecoordinates_11_0= ruleRelativeCoordinate ) ) )*
            loop32:
            do {
                int alt32=2;
                ...
                switch (alt32) {
            	case 1 :
            	    // InternalBgDsl.g:2221:4: otherlv_10= ',' ( (lv_relativecoordinates_11_0= ruleRelativeCoordinate ) )
            	    {
            	    otherlv_10=(Token)match(input,17,FOLLOW_52); 

            	    				newLeafNode(otherlv_10, grammarAccess.getPatternAccess().getCommaKeyword_8_0());
            	    			
            	    // InternalBgDsl.g:2225:4: ( (lv_relativecoordinates_11_0= ruleRelativeCoordinate ) )
            	    // InternalBgDsl.g:2226:5: (lv_relativecoordinates_11_0= ruleRelativeCoordinate )
            	    {
            	    // InternalBgDsl.g:2226:5: (lv_relativecoordinates_11_0= ruleRelativeCoordinate )
            	    // InternalBgDsl.g:2227:6: lv_relativecoordinates_11_0= ruleRelativeCoordinate
            	    {
    ...
    // InternalBgDsl.g:2257:1: entryRuleRelativeCoordinate returns [EObject current=null] : iv_ruleRelativeCoordinate= ruleRelativeCoordinate EOF ;
    public final EObject entryRuleRelativeCoordinate() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:2257:59: (iv_ruleRelativeCoordinate= ruleRelativeCoordinate EOF )
            // InternalBgDsl.g:2258:2: iv_ruleRelativeCoordinate= ruleRelativeCoordinate EOF
            {
    ...
    // InternalBgDsl.g:2264:1: ruleRelativeCoordinate returns [EObject current=null] : (otherlv_0= 'RelativeCoordinate' otherlv_1= '{' otherlv_2= 'x' ( (lv_x_3_0= ruleEInt ) ) otherlv_4= 'y' ( (lv_y_5_0= ruleEInt ) ) otherlv_6= '}' ) ;
    public final EObject ruleRelativeCoordinate() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:2270:2: ( (otherlv_0= 'RelativeCoordinate' otherlv_1= '{' otherlv_2= 'x' ( (lv_x_3_0= ruleEInt ) ) otherlv_4= 'y' ( (lv_y_5_0= ruleEInt ) ) otherlv_6= '}' ) )
            // InternalBgDsl.g:2271:2: (otherlv_0= 'RelativeCoordinate' otherlv_1= '{' otherlv_2= 'x' ( (lv_x_3_0= ruleEInt ) ) otherlv_4= 'y' ( (lv_y_5_0= ruleEInt ) ) otherlv_6= '}' )
            {
            // InternalBgDsl.g:2271:2: (otherlv_0= 'RelativeCoordinate' otherlv_1= '{' otherlv_2= 'x' ( (lv_x_3_0= ruleEInt ) ) otherlv_4= 'y' ( (lv_y_5_0= ruleEInt ) ) otherlv_6= '}' )
            // InternalBgDsl.g:2272:3: otherlv_0= 'RelativeCoordinate' otherlv_1= '{' otherlv_2= 'x' ( (lv_x_3_0= ruleEInt ) ) otherlv_4= 'y' ( (lv_y_5_0= ruleEInt ) ) otherlv_6= '}'
            {
            ...
            // InternalBgDsl.g:2284:3: ( (lv_x_3_0= ruleEInt ) )
            // InternalBgDsl.g:2285:4: (lv_x_3_0= ruleEInt )
            {
            // InternalBgDsl.g:2285:4: (lv_x_3_0= ruleEInt )
            // InternalBgDsl.g:2286:5: lv_x_3_0= ruleEInt
            {
            ...
            otherlv_4=(Token)match(input,67,FOLLOW_16); 

            			newLeafNode(otherlv_4, grammarAccess.getRelativeCoordinateAccess().getYKeyword_4());
            		
            // InternalBgDsl.g:2307:3: ( (lv_y_5_0= ruleEInt ) )
            // InternalBgDsl.g:2308:4: (lv_y_5_0= ruleEInt )
            {
            // InternalBgDsl.g:2308:4: (lv_y_5_0= ruleEInt )
            // InternalBgDsl.g:2309:5: lv_y_5_0= ruleEInt
            {
    ...
    // InternalBgDsl.g:2334:1: ruleTurnType returns [Enumerator current=null] : ( (enumLiteral_0= 'TurnBased' ) | (enumLiteral_1= 'Simultaneous' ) ) ;
    public final Enumerator ruleTurnType() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:2340:2: ( ( (enumLiteral_0= 'TurnBased' ) | (enumLiteral_1= 'Simultaneous' ) ) )
            // InternalBgDsl.g:2341:2: ( (enumLiteral_0= 'TurnBased' ) | (enumLiteral_1= 'Simultaneous' ) )
            {
            // InternalBgDsl.g:2341:2: ( (enumLiteral_0= 'TurnBased' ) | (enumLiteral_1= 'Simultaneous' ) )
            int alt33=2;
            ...
            switch (alt33) {
                case 1 :
                    // InternalBgDsl.g:2342:3: (enumLiteral_0= 'TurnBased' )
                    {
                    // InternalBgDsl.g:2342:3: (enumLiteral_0= 'TurnBased' )
                    // InternalBgDsl.g:2343:4: enumLiteral_0= 'TurnBased'
                    {
                    ...
                    break;
                case 2 :
                    // InternalBgDsl.g:2350:3: (enumLiteral_1= 'Simultaneous' )
                    {
                    // InternalBgDsl.g:2350:3: (enumLiteral_1= 'Simultaneous' )
                    // InternalBgDsl.g:2351:4: enumLiteral_1= 'Simultaneous'
                    {
    ...
    // InternalBgDsl.g:2361:1: ruleStateSelection returns [Enumerator current=null] : ( (enumLiteral_0= 'CurrentPlayer' ) | (enumLiteral_1= 'OtherPlayer' ) | (enumLiteral_2= 'StateBased' ) ) ;
    public final Enumerator ruleStateSelection() throws RecognitionException {
        ...
        try {
            // InternalBgDsl.g:2367:2: ( ( (enumLiteral_0= 'CurrentPlayer' ) | (enumLiteral_1= 'OtherPlayer' ) | (enumLiteral_2= 'StateBased' ) ) )
            // InternalBgDsl.g:2368:2: ( (enumLiteral_0= 'CurrentPlayer' ) | (enumLiteral_1= 'OtherPlayer' ) | (enumLiteral_2= 'StateBased' ) )
            {
            // InternalBgDsl.g:2368:2: ( (enumLiteral_0= 'CurrentPlayer' ) | (enumLiteral_1= 'OtherPlayer' ) | (enumLiteral_2= 'StateBased' ) )
            int alt34=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt34) {
                case 1 :
                    // InternalBgDsl.g:2369:3: (enumLiteral_0= 'CurrentPlayer' )
                    {
                    // InternalBgDsl.g:2369:3: (enumLiteral_0= 'CurrentPlayer' )
                    // InternalBgDsl.g:2370:4: enumLiteral_0= 'CurrentPlayer'
                    {
                    ...
                    break;
                case 2 :
                    // InternalBgDsl.g:2377:3: (enumLiteral_1= 'OtherPlayer' )
                    {
                    // InternalBgDsl.g:2377:3: (enumLiteral_1= 'OtherPlayer' )
                    // InternalBgDsl.g:2378:4: enumLiteral_1= 'OtherPlayer'
                    {
                    ...
                    break;
                case 3 :
                    // InternalBgDsl.g:2385:3: (enumLiteral_2= 'StateBased' )
                    {
                    // InternalBgDsl.g:2385:3: (enumLiteral_2= 'StateBased' )
                    // InternalBgDsl.g:2386:4: enumLiteral_2= 'StateBased'
                    {
    ...
    public static final BitSet FOLLOW_36 = new BitSet(new long[]{0x2448000000000000L});
    public static final BitSet FOLLOW_37 = new BitSet(new long[]{0x0000010000000000L});
    public static final BitSet FOLLOW_38 = new BitSet(new long[]{0x0000020000000000L});
    public static final BitSet FOLLOW_39 = new BitSet(new long[]{0x0000040000000000L});
    public static final BitSet FOLLOW_40 = new BitSet(new long[]{0x0000000800040000L});
    public static final BitSet FOLLOW_41 = new BitSet(new long[]{0x0000900000040000L});
    public static final BitSet FOLLOW_42 = new BitSet(new long[]{0x0000200000000000L});
    public static final BitSet FOLLOW_43 = new BitSet(new long[]{0x0000400000020000L});
    public static final BitSet FOLLOW_44 = new BitSet(new long[]{0x0000800000040000L});
    ...
    public static final BitSet FOLLOW_50 = new BitSet(new long[]{0x0090000000000000L});
    ...
    public static final BitSet FOLLOW_57 = new BitSet(new long[]{0x1010000000040000L});
    public static final BitSet FOLLOW_58 = new BitSet(new long[]{0x0010000000040000L});
    public static final BitSet FOLLOW_59 = new BitSet(new long[]{0x8800000000000000L,0x0000000000000001L});
