 ...
 * @generated
 */
public class PatternFilterImpl extends FilterImpl implements PatternFilter {
	/**
	...
	protected EClass eStaticClass() {
		return BgPackage.Literals.PATTERN_FILTER;
	}
	...
	public EList<Pattern> getPatterns() {
		if (patterns == null) {
			patterns = new EObjectContainmentEList<Pattern>(Pattern.class, this, BgPackage.PATTERN_FILTER__PATTERNS);
		}
		return patterns;
	}
