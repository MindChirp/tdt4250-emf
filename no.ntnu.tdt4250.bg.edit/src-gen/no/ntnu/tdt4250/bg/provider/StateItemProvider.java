...
/**
 * This is the item provider adapter for a {@link no.ntnu.tdt4250.bg.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addOutboundPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_outbound_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_outbound_feature", "_UI_State_type"),
						BgPackage.Literals.STATE__OUTBOUND, true, false, true, null, null, null));
	}
	...
	protected void addInboundPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_inbound_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_inbound_feature", "_UI_State_type"),
						BgPackage.Literals.STATE__INBOUND, true, false, true, null, null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BgPackage.Literals.STATE__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addHexColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_hexColor_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_hexColor_feature", "_UI_State_type"),
						BgPackage.Literals.STATE__HEX_COLOR, true, false, false,
