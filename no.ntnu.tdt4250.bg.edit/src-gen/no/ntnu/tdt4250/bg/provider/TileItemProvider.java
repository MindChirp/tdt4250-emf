...
/**
 * This is the item provider adapter for a {@link no.ntnu.tdt4250.bg.Tile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TileItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTileTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BgPackage.Literals.TILE__TILE_TYPE, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BgPackage.Literals.TILE__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BgPackage.Literals.TILE__STATES);
			childrenFeatures.add(BgPackage.Literals.TILE__TRANSITIONS);
			childrenFeatures.add(BgPackage.Literals.TILE__INITIAL_STATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(BgPackage.Literals.TILE__STATES, BgFactory.eINSTANCE.createState()));

		newChildDescriptors.add(
				createChildParameter(BgPackage.Literals.TILE__TRANSITIONS, BgFactory.eINSTANCE.createTransition()));

		newChildDescriptors
				.add(createChildParameter(BgPackage.Literals.TILE__INITIAL_STATE, BgFactory.eINSTANCE.createState()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == BgPackage.Literals.TILE__STATES
				|| childFeature == BgPackage.Literals.TILE__INITIAL_STATE;
